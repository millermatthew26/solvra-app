...
# Resolve to the parent of solvra_kernel_v2/tests → solvra_kernel_v2/
...
from solvra_kernel.engines.ingestion_service import ValidationError
...
def test_quality_weight_reduction():
    ...
    from solvra_kernel.models.entities import Measurement, SourceType, QualityFlag
    m = Measurement(
...
class TestPopulationContextEngine(unittest.TestCase):
    ...
    def setUp(self):
        from solvra_kernel.engines.baseline_engine import PopulationContextEngine
        from solvra_kernel.engines.audit_engine import AuditEngine
        from solvra_kernel.models.entities import DerivedFeature, UncertaintyLevel
    ...
    def test_note_language_is_non_diagnostic(self):
        ...
        from solvra_kernel.models.entities import BaselineContextStatus
...
class TestDigitalTwinPhaseTracking(unittest.TestCase):
    ...
    def test_new_user_is_phase_1(self):
        ...
        from solvra_kernel.models.entities import DigitalTwinPhase
        self.assertEqual(
    ...
    def test_twin_phase_dict_covers_all_signals(self):
        ...
        from solvra_kernel.models.entities import SIGNAL_DEFINITIONS
